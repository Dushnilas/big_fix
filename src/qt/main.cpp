...
{
    initializePythonInterpreter("/Users/maykorablina/Yandex.Disk.localized/CodingProjects/big_fix_3/src/qt/libraries/mysql-queries");
...
////     ------------------ INSERT LOG INTO LOG TABLE --------------
    // select = ExecuteSelectQuery("library", "SELECT genre_name FROM genres ORDER BY genre_name ASC");
    // print_select(select);
//    data = {
